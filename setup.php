...
define('EDITABLE_FORMATS', 'txt,md,conf,crt,csr,key');
...
<div id="top">
	<header>
		<h1><a href="/" target="_blank" title="Router Simple Config">Router Simple Config</a></h1>
                ...
                <a href="status.php">[Router Status]</a></span>
                <a href="reboot.php">[Apply & Reboot]</a></span>
	</header>
